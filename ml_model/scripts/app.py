...
model = joblib.load('/home/ec2-user/Music-Weather-Recommender/ml_model/models/music_weather_model.pkl')
song_df = pd.read_csv('/home/ec2-user/Music-Weather-Recommender/ml_model/data/278k_labelled_uri.csv')  # Make sure to update this path
